...
(unless (>= 24 emacs-major-version)
  (error "loothe-theme requires Emacs 24 or later."))
...
(let*  (
       ...
       (turquoise-1      "#ff44ff")
       (turquoise-2      "#ff99ff")
       (turquoise-1bg    "#ffaaff")
       (turquoise-2bg    "#ffeeff")
       (blue-1           "#0000ff")
       (blue-2           "#5555ff")
       (blue-3           "#9999ff")
       (blue-4           "#aaaaff")
  ...
  (custom-theme-set-faces
   ...
   `(escape-glyph                              ((t (:foreground "#000"       :background ,purple-1bg                    ))))
   `(error                                     ((t (:foreground "#000"       :background ,red-1bg                       ))))
   ;;-----------------------------------------------------------------------------------------------------------------------
   ;; Font-lock stuff
   `(font-lock-builtin-face                    ((t (:foreground ,red-2       :background ,red-1bg                       ))))
   `(font-lock-constant-face                   ((t (:foreground ,blue-1    :background ,background                    ))))
   `(font-lock-comment-face                    ((t (:foreground "#aaa" :background ,background :italic t      ))))
   ...
   ;;-----------------------------------------------------------------------------------------------------------------------
   ;; Linum
   `(linum                                     ((t (:foreground "#000" :background ,alt-background :height 110   ))))
   ;;-----------------------------------------------------------------------------------------------------------------------
   ;; show-paren-mode
   ...
   `(highlight-indentation-face                ((t (                         :background "#e0e0e0"               ))))
...
;; Rainbow delimiters
(defun loothe-rainbow-delim-set-face ()
  (set-face-attribute 'rainbow-delimiters-depth-1-face   nil :foreground "#ff0000")
  (set-face-attribute 'rainbow-delimiters-depth-2-face   nil :foreground "#ff00ff")
  (set-face-attribute 'rainbow-delimiters-depth-3-face   nil :foreground "#0000ff")
  (set-face-attribute 'rainbow-delimiters-depth-4-face   nil :foreground "#555")
  (set-face-attribute 'rainbow-delimiters-depth-5-face   nil :foreground "#009999")
  (set-face-attribute 'rainbow-delimiters-depth-6-face   nil :foreground "#00ff00")
  (set-face-attribute 'rainbow-delimiters-depth-7-face   nil :foreground "#000")
  (set-face-attribute 'rainbow-delimiters-depth-8-face   nil :foreground "#aaaaaa")
  (set-face-attribute 'rainbow-delimiters-depth-9-face   nil :foreground "#777")
  (set-face-attribute 'rainbow-delimiters-unmatched-face nil :foreground "#990000"))


(eval-after-load "rainbow-delimiters" '(loothe-rainbow-delim-set-face))
